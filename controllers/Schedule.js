...
module.exports = {
    ...
    Open_Schedule: (req, res, next) => {
        ...
        //-----------
        let start_time = req.body.start_time;
        let sql = `SELECT end_time,start_time,status,working_time FROM schedule_details JOIN schedule ON schedule_details.id_Schedule = schedule.id WHERE start_time LIKE '${start_time}%'`;
